...
| **Video studio** (4.5) | Turn a clip into a shareable time-lapse: **10–240× speed-up**, your own intro (video or logo image), text in the picture, background music with smooth fade in/out, editable title and description. Preview before anything leaves the Pi; automatic for alert videos. YouTube upload comes in 4.6. |
