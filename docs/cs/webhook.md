...
Atmovio žije v domácí síti. Aby ses na kamery a upozornění podíval odkudkoli bez otevírání portů, Atmovio **posílá**
...
## Nastavení ve Atmovio

**Nastavení → Upozornění → Kam chodí upozornění: vlastní web (webhook)**

- **Adresa přijímače** – přesná finální URL (`https://example.com/atmovio/webhook.php`). Bez přesměrování (`www`, lomítko na konci) – přesměrování změní POST na GET.
