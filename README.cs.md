...
| **Video studio** (4.5) | Z vystřiženého klipu udělá časosběr na sdílení: **zrychlení 10–240×**, vlastní intro (video nebo obrázek s logem), text v obraze, hudba s plynulým náběhem a doběhem, upravitelný titulek a popis. Výsledek vidíš dřív, než kamkoli odejde; pro videa po upozornění automaticky. **Nahrání na YouTube** (4.6) i s playlisty, ručně nebo automaticky – [`docs/youtube.md`](docs/youtube.md). |
